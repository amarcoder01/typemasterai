...
- **AI Services**: OpenAI (GPT-4o-mini for bot username generation, code snippet generation, and chat assistant with function calling for web search).
- **Web Search**: Bing Search API v7.0 (dual-key configuration for failover), Tavily API (secondary), DuckDuckGo (final fallback).
