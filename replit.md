...
- **AI Services**: 
  - OpenAI (GPT-4o-mini for bot username generation, code snippet generation, and chat assistant responses)
  - Azure AI Foundry (gpt-4o-mini deployment with Grounding with Bing Search for web-grounded AI chat)
- **Web Search**: Azure AI Foundry Bing Grounding (primary via Azure AI Agent Service), Tavily API (fallback), DuckDuckGo (final fallback).
